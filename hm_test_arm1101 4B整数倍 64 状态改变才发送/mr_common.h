...
/* mac layer contants */
#define MAX_SLTS_PCF		63			/* slot number per complex frame */
...
#define SN_HMTEST			100					/* sub number of creating or getting the queue id of routing process */
...
#ifdef _HM_TEST
#define PNAME_H2T	   		"hm2test"
#endif 
#define PNAME_HM_TEST       "hmtest"
